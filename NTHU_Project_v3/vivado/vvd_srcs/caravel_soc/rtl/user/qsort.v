   ...
   if (c_state == SORT_ARRAY) begin // ref : https://bertdobbelaere.github.io/sorting_networks.html#N11L35D8
        case (cnt_sort)
            ...
            6:begin
                ...
                next_ARRAY[1] = ARRAY[1];
                next_ARRAY[8] = ARRAY[8];
            end
            default:begin
                next_ARRAY[0] = ARRAY[0];
                next_ARRAY[9] = ARRAY[9];
                ...
                next_ARRAY[2] = ARRAY[2];
                next_ARRAY[7] = ARRAY[7];
                
                next_ARRAY[3] = ARRAY[3];
                next_ARRAY[6] = ARRAY[6];
                
                next_ARRAY[4] = ARRAY[4];
                next_ARRAY[5] = ARRAY[5];
            end
