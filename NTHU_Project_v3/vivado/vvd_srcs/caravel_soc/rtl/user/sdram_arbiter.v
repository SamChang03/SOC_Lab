module SDRAM_arbiter (
    ...
    wire [22:0] prefetch_address_QS0;
    wire [22:0] prefetch_address_QS1;
    wire [22:0] prefetch_address_QS2;
    ...
    reg [22:0] prefetch_address_QS [0:2], next_prefetch_address_QS [0:2];
    reg [22:0] QS_address_saved, next_QS_address_saved;
            ...
            FIFO_PREFETCH: begin
                ...
                if(prefetch_counter==2'd2) begin
                    ...
                    if(request_FIFO[0][3]==1) begin // CPU
                        ...
                        next_prefetch_address_QS[2]=prefetch_address_QS[2];
                        next_prefetch_buffer_QS[0]=prefetch_buffer_QS[0];
                        next_prefetch_buffer_QS[1]=data_from_controller;
                        next_prefetch_buffer_QS[2]=prefetch_buffer_QS[2];
                        for(i=0;i<3;i=i+1)begin
                            next_prefetch_buffer_CPU[i] <= prefetch_buffer_CPU[i];
                            next_prefetch_address_CPU[i] <= prefetch_address_CPU[i];
                            next_prefetch_buffer_FIR[i] <= prefetch_buffer_FIR[i];
